...
class floatedMini {
    function __construct() {
        ...
        add_shortcode( 'floated_mini', array( $this, 'renderHTML' ) );
    ...
    public function integrateWithVC() {
        ...
        */
        vc_map( array(
            "name" => __("Floated Mini", 'vc_extend'),
            "description" => __("Image and content bubble at bottom", 'vc_extend'),
    ...
    */
    public function renderHTML( $atts, $content = null ) {
        ...
        $html = '
        <div class="floated floated--mini '. $additional_class .'">
