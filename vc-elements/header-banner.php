...
class headerBanner {
    function __construct() {
        ...
        add_shortcode( 'header_banner', array( $this, 'renderHTML' ) );
    ...
    public function integrateWithVC() {
        ...
        */
        vc_map( array(
            "name" => __("Header Banner", 'vc_extend'),
            "description" => __("Home page like banner", 'vc_extend'),
    ...
    */
    public function renderHTML( $atts, $content = null ) {
        ...
        $html = '
        <section class="wpc-directory-wrap banner-with-text header--banner vc-banner">
