<?php
/*
    Element: Image Border Content
*/

// don't load directly
if (!defined('ABSPATH')) die('-1');

class imageBorderContent {
    function __construct() {
        // We safely integrate with VC with this hook
        add_action( 'init', array( $this, 'integrateWithVC' ) );

        // Use this when creating a shortcode addon
        add_shortcode( 'image_border_content', array( $this, 'renderHTML' ) );
    ...
    public function integrateWithVC() {
        ...
        */
        vc_map( array(
            "name" => __("Image Border Content Right", 'vc_extend'),
            "description" => __("Image at left. Content at right", 'vc_extend'),
            //"group" => "Custom Elements",
            "base" => "image_border_content",
            "class" => "",
            "controls" => "full",
    ...
    */
    public function renderHTML( $atts, $content = null ) {
        ...
        $html = '
        <section class="section__content-boxed">
            <div class="d-flex">
                <div class="image-box">
