<?php
/*
    Element: Contact For Treatment
*/

// don't load directly
if (!defined('ABSPATH')) die('-1');

class contactForTreatment {

    public $block_settings_id = 642;
    public $description =  "";
    public $shortcode = "";
    public $bgImg = "";
    ...
    function __construct() {
        ...
        add_shortcode( 'contact_for_treatment', array( $this, 'renderHTML' ) );
    ...
    public function integrateWithVC() {
        ...
        */
        vc_map( array(
            "name" => __("Contact For Treatment", 'vc_extend'),
            "description" => __("Contact form in treatments", 'vc_extend'),
            //"group" => "Custom Elements",
            "base" => "contact_for_treatment",
            "class" => "",
            "controls" => "full",
    ...
    */
    public function renderHTML( $atts, $content = null ) {
        ...
        $html = '
        <section class="section__welcome treatment__contact">
            <h3>'. $title .'</h3>
            <div class="row">
                <div class="col-sm-6">
